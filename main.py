...
from support_vector_regression import svr_regressor
from decision_tree_regression import dtr_regressor
from random_forest_regression import rfr_regressor
from sklearn.metrics import r2_score
from sklearn.preprocessing import StandardScaler
import pandas as pd
scaler = StandardScaler()  # A new scaler is used as to prevent information leak
if __name__ == '__main__':
    ...
    print(f'Support Vector Regression Score -> {r2_score(scaler.fit_transform(y.reshape(-1, 1)), svr_predict)}')
